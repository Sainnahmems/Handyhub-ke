...
import com.example.handyhubke.databinding.FragmentCustomerProfileBinding
...
class CustomerProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnUpdateCustomerProfile.setOnClickListener {
            Toast.makeText(requireContext(), "Customer profile updated successfully", Toast.LENGTH_SHORT).show()
        }
